...
const CountryInfo: FC<CountryInfoProps> = ({ country, countryCode, year, mobileHidden }) => {
	return <div className='flex items-center'>
		{ countryCode && <div className='group relative'>
			<div
				className="absolute bottom-[calc(100%+0.2rem)] left-[50%] -translate-x-[50%] hidden group-hover:block lg:group-hover:hidden w-auto">
		...
		<p className='ml-2.5 text-sm font-medium text-gray-500'>
